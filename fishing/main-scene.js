...
//          context.globals.graphics_state.camera_transform = Mat4.look_at( Vec.of( 0, -20, 15 ), Vec.of( 0,0,0 ), Vec.of( 0,10, 0 ) );
        ...
        const shapes = { box:       new Cube(),
                         ...
                         tree_stem: new Shape_From_File( "fishing/assets/MapleTreeStem.obj" ),
                         tree_leaves: new Shape_From_File( "fishing/assets/MapleTreeLeaves.obj" ),
                         grass:     new Shape_From_File( "fishing/assets/Grass_03.obj"),
                         rock:      new Shape_From_File( "fishing/assets/Rock.obj"),
                         circle:    new Circle(),
